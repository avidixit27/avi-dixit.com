...
| [005 — Responsive media and performance](005-responsive-media-performance-foundation.md) | In progress | 004        | `feat/responsive-media-foundation`  | `fix/dependabot-compatibility-guards` | Pending                                                    |
