...
| --------------------------------------------------------------------------------------- | --------- | ---------- | ----------------------------------------- | ----------------------------------------- | ---------------------------------------------------------- |
| [008 — Responsive presentation regressions](008-responsive-presentation-regressions.md) | In review | 007        | `fix/responsive-presentation-regressions` | `main`                                    | [#25](https://github.com/avidixit27/avi-dixit.com/pull/25) |
