...
| ------------------------------------------------------------------------------------------------------ | ----------- | ---------- | ----------------------------------------- | ----------------------------------------- | ---------- |
| [007 — Tailwind 4 and configuration simplification](007-tailwind4-and-configuration-simplification.md) | In progress | 006        | `chore/tailwind4-config-simplification`   | `main`                                    | Not opened |
