...
| -------------------------------------------------------------------------------------------- | ------- | --------------------------------------- | ---------- |
| [015 — Browser-test reliability](015-browser-test-reliability.md)                            | Planned | `test/browser-test-reliability`         | 014        |
...
Plans 015–017 are approved, with Plan 015 next for implementation. Plan 015 includes CT and related E2E failures, execution evidence, diagnostics, and evaluation of container parity before adoption. Former plans 015–020 were renumbered to 016–021 at the user's request. Implementation has not started.
