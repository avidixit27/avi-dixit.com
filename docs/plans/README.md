...
| --------------------------------------------------------------------------------------- | ----------- | ---------- | ----------------------------------------- | ----------------------------------------- | ---------- |
| [008 — Responsive presentation regressions](008-responsive-presentation-regressions.md) | In progress | 007        | `fix/responsive-presentation-regressions` | `main`                                    | Not opened |
