          ...
          <div className="flex flex-col lg:flex-row gap-8">
            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {products.map(product => (
                <div key={product.id} className="bg-slate-800 rounded-lg overflow-hidden hover:shadow-xl transition-shadow">
                  <div className="aspect-square bg-slate-700" />
                  <div className="p-4">
                    <h3 className="text-xl font-semibold mb-2">{product.title}</h3>
                    <p className="text-accentVivid text-lg mb-4">${product.price}</p>
                    <button 
            ...
            <div className="w-full lg:w-80 bg-slate-800 p-6 rounded-lg h-fit sticky top-36">
              ...
              <div className="border-t border-slate-700 pt-4">
                <div className="flex justify-between mb-4">
                  <span>Total:</span>
                  <span className="text-accentVivid">${totalPrice}</span>
                </div>
                <button 
                  className="w-full py-3 bg-accent hover:bg-accentWarm text-white font-bold transition-colors disabled:opacity-50"
